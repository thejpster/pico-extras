...
#define PICO_SCANVIDEO_PIXEL_FROM_RGB8(r, g, b) ((((b)>>4u)<<PICO_SCANVIDEO_PIXEL_BSHIFT)|(((g)>>4u)<<PICO_SCANVIDEO_PIXEL_GSHIFT)|(((r)>>4u)<<PICO_SCANVIDEO_PIXEL_RSHIFT))
#endif

#ifndef PICO_SCANVIDEO_PIXEL_FROM_RGB5
#define PICO_SCANVIDEO_PIXEL_FROM_RGB5(r, g, b) ((((b)>>1)<<PICO_SCANVIDEO_PIXEL_BSHIFT)|(((g)>>1)<<PICO_SCANVIDEO_PIXEL_GSHIFT)|(((r)>>1)<<PICO_SCANVIDEO_PIXEL_RSHIFT))
#endif

#ifndef PICO_SCANVIDEO_R5_FROM_PIXEL
#define PICO_SCANVIDEO_R5_FROM_PIXEL(p) ((((p)>>PICO_SCANVIDEO_PIXEL_RSHIFT)&0x0f) << 1)
#endif

#ifndef PICO_SCANVIDEO_G5_FROM_PIXEL
#define PICO_SCANVIDEO_G5_FROM_PIXEL(p) ((((p)>>PICO_SCANVIDEO_PIXEL_GSHIFT)&0x0f) << 1)
#endif

#ifndef PICO_SCANVIDEO_B5_FROM_PIXEL
#define PICO_SCANVIDEO_B5_FROM_PIXEL(p) ((((p)>>PICO_SCANVIDEO_PIXEL_BSHIFT)&0x0f) << 1)
#endif
